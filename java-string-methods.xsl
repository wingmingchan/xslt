<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="java stringmethods" version="1.0" xmlns:java="http://xml.apache.org/xalan/java" xmlns:stringmethods="http://www.upstate.edu/chanw/stringmethods">
